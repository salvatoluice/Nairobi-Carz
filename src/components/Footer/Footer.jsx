        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Ngong Lane Plaza, Ngong rd, Nairobi Kenya</p>
              <p className="office__info">Phone: +254-1-13-794-219</p>

              <p className="office__info">Email: salvatoluice5@gmail.com</p>

              <p className="office__info">Office hours: 7am - 6pm</p>
            </div>
          </Col>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Salvato Luis. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
